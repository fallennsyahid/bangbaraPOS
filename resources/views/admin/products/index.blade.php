                        ...
                        <div class="flex justify-between items-center w-full max-w-4xl">
                            ...
                            <div class="flex space-x-3">
                                ...
                                <a href="{{ route('products.create') }}"
                                    class="px-4 py-2 text-sm text-gray-900 font-semibold shadow-md rounded-md bg-gray-300 hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-500">
                                    Create +
                                </a>
                            </div>
                        </div>
