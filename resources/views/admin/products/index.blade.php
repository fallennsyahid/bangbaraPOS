                        ...
                        <div class="flex mx-auto space-x-5 justify-between">
                            <div class="">
                                <select id="categoryFilter"
                                    class="bg-red-700 text-white rounded-lg px-4 py-2 shadow-lg focus:ring-2 focus:ring-amber-300 focus:outline-none transition duration-300 transform hover:shadow-2xl">
                            ...
                            <table class="table-auto border-collapse w-full text-left shadow-lg rounded-md"
                                ...
                                <tbody class="bg-[#CAAC44]" id="productTable">
                                    @foreach ($products as $index => $product)
                                        <tr class="hover:bg-yellow-300" data-category="{{ $product->category_id }}">
