<!-- Navbar -->
<header class="relative bg-white dark:bg-zinc-900">
    <div class="flex items-center justify-between p-2">
        ...
        <nav aria-label="Secondary" class="hidden space-x-2 md:flex md:items-center">
            ...
            <button @click="openNotificationsPanel"
                class="p-2 transition-colors duration-200 rounded-full text-white bg-yellow-300 dark:bg-red-700 hover:bg-red-700 dark:hover:text-light dark:hover:bg-amber-300">
            ...
            <button @click="openSettingsPanel"
                class="p-2 transition-colors duration-200 rounded-full text-white bg-red-700 hover:bg-yellow-300 dark:hover:text-light dark:hover:bg-red-700 dark:bg-yellow-300">
